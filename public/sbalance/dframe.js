const _common_page = {
  ...
  _event_function($element, event) {
    $element.each(function (idx, element) {
      ...
      if (fnCallback != null) return fnCallback.call(element);
    });
  }
};
...
function dframeCreate(element_id, owner) {
  ...
  return {
    ...
    addHistory: function (dpage) {
      this._history.push(dpage);
    },
    popHistory: function () {
      var self = this;
      var dpage = null;
    ...
    openPage: function (page_file, page_title, page_param, callback) {
      ...
      var page_url = "/sbalance/pages" + page_file;
      $.get(page_url, function (data) {
        try {
          ...
          $page.each(function (idx, epage) {
            ...
            // epage._dpage = dpage;
            epage.getPage = function () {
              return dpage;
            };
            epage.getParam = function () {
              return page_param;
            };
          });
